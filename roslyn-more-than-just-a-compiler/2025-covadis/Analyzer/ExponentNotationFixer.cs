...
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(ExponentNotationFixer)), Shared]
public class ExponentNotationFixer : CodeFixProvider
{
    private const string Title = "Replace with exponent notation";
    ...
    private static async Task<Solution> RewriteToExponentNotation(Document document,
